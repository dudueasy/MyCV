...
!function (a, b) {
  ...
  var c = [],
      ...
      n = m.call(Object),
      o = {};function p(a, b) {
    b = b || d;var c = b.createElement("js");c.text = a, b.head.appendChild(c).parentNode.removeChild(c);
  }var q = "3.2.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/js,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector",
      r = function r(a, b) {
    ...
    for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++) {
      ...
      if (d && r.inArray(f, d) > -1) e && e.push(f);else if (j = r.contains(f.ownerDocument, f), g = na(l.appendChild(f), "js"), j && oa(g), c) {
        k = 0;while (f = g[k++]) {
    ...
    b = g.apply([], b);var e,
      ...
      for (h = r.map(na(e, "js"), Fa), i = h.length; l < m; l++) {
        j = e, l !== n && (j = r.clone(j, !0, !0), i && r.merge(h, na(j, "js"))), c.call(a[l], j, l);
    ...
    for (var d, e = b ? r.filter(b, a) : a, f = 0; null != (d = e[f]); f++) {
      c || 1 !== d.nodeType || r.cleanData(na(d)), d.parentNode && (c && r.contains(d.ownerDocument, d) && oa(na(d, "js")), d.parentNode.removeChild(d));
    }return a;
      ...
      var d,
        ...
        Ha(f[d], g[d]);
      } else Ha(a, h);return g = na(h, "js"), g.length > 0 && oa(g, !i && na(a, "js")), h;
