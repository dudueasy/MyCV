  ...
  return function (t) {
    ...
    function r(t) {
      ...
      var e = t.method,
          ...
          p = t.onprogress,
          _ = t.timeout,
          v = h++;u("request(" + v + ")", e, n, r, s, d);var y = {};if (r) for (var m in r) {
      ...
      var r = e.split("."),
        ...
        w = function w(t, e) {
      for (var n = e.split("."), r = n.pop(), i = t, s = 0; s < n.length; s++) {
        if (void 0 === (i = i[n[s]])) return [void 0, void 0, r];
      }return [i[r], i, r];
    ...
    var r = n(0),
      ...
      t.User = t.Object.extend("_User", { _isCurrentUser: !1, _mergeMagicFields: function _mergeMagicFields(e) {
        ...
        }, signUpOrlogInWithAuthDataAndUnionId: function signUpOrlogInWithAuthDataAndUnionId(t, e, n, r) {
      ...
      */
      !function (e, n) {
        ...
        function t(t) {
          ...
          var e = this;if (t && "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && t.constructor === e) return t;var n = new e(l);return m(n, t), n;
